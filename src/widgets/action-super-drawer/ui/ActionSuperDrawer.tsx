...
export function ActionSuperDrawer({
 ...
 <div className="bg-[#700000] text-white px-4 py-2 flex items-center gap-2">
...
function DrawerHeader({
 ...
 return (
 <div className="px-4 py-4 border-b border-slate-200 bg-surface/70 backdrop-blur-md flex items-start justify-between gap-4 shrink-0">
...
function IronVaultSection({ action }: { action: ActionAgingMetrics }) {
 const snapshot = action.finding_snapshot;
 return (
 <div className="px-4 py-5 border-b border-slate-200 bg-surface">
