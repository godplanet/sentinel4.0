...
import {
  ThermometerSun, Droplets, DoorOpen, DoorClosed, 
  Wifi, WifiOff, Siren, CheckCircle2, AlertTriangle,
  ChevronRight, Battery, ShieldAlert, Zap
} from 'lucide-react';
import {
  useSensorData, useResolveBreach, usePhysicalBreaches,
