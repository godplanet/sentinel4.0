...
export function PADMonitor() {
 ...
 <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl p-4 text-white shadow-xl relative overflow-hidden border border-slate-700/50">
