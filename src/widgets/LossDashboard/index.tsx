...
import {
  ...
  Shield, Loader2, ChevronRight, X, FileWarning,
  BadgeDollarSign, Scale,
} from 'lucide-react';
import {
  useOperationalLosses, useRegulatoryFines, useOrmKPI,
  useUpdateLossStatus, useMarkFinePaid,
  formatTRY,
  type OperationalLoss, type RegulatoryFine, type LossStatus,
