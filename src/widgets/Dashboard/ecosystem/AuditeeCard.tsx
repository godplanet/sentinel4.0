...
import { Building2, Loader2, Clock, CheckCircle2, AlertCircle, Timer } from 'lucide-react';
...
const STATUS_MAP: Record<string, { label: string; color: string }> = {
  ...
  PENDING_REVIEW: { label: 'Inceleme', color: '#3b82f6' },
  SENT_TO_AUDITEE: { label: 'Gonderildi', color: '#f59e0b' },
  AUDITEE_REVIEWING: { label: 'Inceleniyor', color: '#8b5cf6' },
  PENDING_APPROVAL: { label: 'Onay Bekliyor', color: '#06b6d4' },
  FINAL: { label: 'Kesinlesti', color: '#ef4444' },
  REMEDIATED: { label: 'Giderildi', color: '#10b981' },
  CLOSED: { label: 'Kapandi', color: '#6b7280' },
};
