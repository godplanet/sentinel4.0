import type { WelcomeSummary, AIBrief } from '@/entities/dashboard/model/types';
import { Brain, Activity, Calendar, AlertCircle, CheckCircle, AlertTriangle } from 'lucide-react';
