...
import { useCultureDashboard, type CultureCategory, type CultureSurvey, type SentimentLabel, type SentimentScore } from '@/features/risk-culture/api';
import clsx from 'clsx';
import { motion } from 'framer-motion';
import {
 AlertTriangle, Building2, Calendar, FileText,
 HeartPulse,
 Loader2,
 Megaphone,
 Shield,
