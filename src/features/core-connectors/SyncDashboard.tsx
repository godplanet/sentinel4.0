...
import {
  Database, Activity, CheckCircle2, XCircle, AlertTriangle,
  RefreshCw, Play, Pause, Loader2, ChevronRight, Server,
  Wifi, WifiOff, Clock, ArrowRight,
} from 'lucide-react';
import {
  usePipelines, usePipelineSummary, useSyncLogs,
  useTriggerSync, useTogglePipeline,
...
function PipelineCard({
  ...
  const isHealthy = !!pipeline.last_success_at && !pipeline.last_error_at;
