...
import { calculateAuditScore, calculateRisk, type Finding, type RiskSeverity } from '@/entities/risk';
import { cn } from '@/shared/lib/utils';
import { ShieldAlert, TrendingDown, Repeat, Trash2, Info } from 'lucide-react';
