...
export const NewFindingModal = ({ isOpen, onClose, onSave, workpaperId, engagementId }: NewFindingModalProps) => {
 ...
 {/* RİSK & ETKİ */}
 {activeSection === 'risk' && (
 <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 animate-in fade-in slide-in-from-bottom-2">
 ...
 {/* ETKİ AÇIKLAMASI */}
 <div className="bg-surface rounded-xl border border-slate-200 shadow-sm p-4 flex flex-col min-h-[400px]">
 ...
 <div className="bg-surface rounded-xl p-4 border border-orange-100 shadow-sm ring-1 ring-inset ring-orange-50">
 ...
 disabled={isSubmitting}
 className="px-4 py-2 bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition-all text-xs font-black flex items-center gap-1.5 shadow-md hover:shadow-lg disabled:opacity-70"
 >
