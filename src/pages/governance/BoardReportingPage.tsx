...
function QaipTab() {
 ...
 <h3 className="text-sm font-semibold text-slate-800 mb-2">İç Denetim Bağımsızlık Beyanı</h3>
 ...
 <div>
 <h3 className="text-sm font-semibold text-emerald-900">QAIP Durumu</h3>
...
export default function BoardReportingPage() {
 ...
 <div className="flex flex-wrap items-center gap-3 mt-2 py-2 px-3 rounded-xl bg-surface border border-slate-200 shadow-sm">
 ...
 <span className={clsx('text-sm font-bold tabular-nums', criticalCount ? 'text-red-600' : 'text-slate-700')}>
 {criticalCount}
 </span>
 </div>
 <div className="w-px h-6 bg-slate-200" />
 ...
 <span className={clsx('text-sm font-bold tabular-nums', escalationCount ? 'text-amber-600' : 'text-slate-700')}>
 {escalationCount}
 </span>
 </div>
 </div>

 <div className="border-b border-slate-200 bg-surface rounded-t-xl overflow-hidden mt-2">
 ...
 id="board-panel"
 className="rounded-b-xl border border-t-0 border-slate-200 bg-surface shadow-sm p-3 min-h-[240px] w-full"
 >
