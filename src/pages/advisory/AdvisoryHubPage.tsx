...
export default function AdvisoryHubPage() {
 ...
 <div className="px-4 py-4 border-b border-slate-200 bg-gradient-to-r from-blue-50 to-cyan-50">
 ...
 <div className="bg-surface border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
 <div className="px-4 py-4 border-b border-slate-200 bg-gradient-to-r from-cyan-50 to-teal-50">
 <h2 className="text-sm font-bold text-slate-800 flex items-center gap-2">
 ...
 className="px-4 py-4 hover:bg-canvas transition-colors cursor-pointer group"
 >
